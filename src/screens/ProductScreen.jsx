...
export default function ProductScreen() {
  return (
    ...
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.tagline}>Price and other details may vary based on product aside and colour{' '}</Text>
     ...
     {ProductData.map((item)=> (
       ...
       <View style={styles.productDetailSection}>
         ...
         <View style={styles.row}>
           ...
           <Text style={styles.raitingCount}>{item.ratingCount}</Text>
         </View>
         <View style={styles.row}>
         ...
         <Text style={styles.cashback}>FREE Delivery by date {item.deliveryBy} </Text>
       </View>
     </View>
     ))}
    </ScrollView>
